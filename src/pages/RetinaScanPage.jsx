  ...
  return (
    <Container maxWidth="lg" sx={{ py: 5 }}>
      ...
      <Typography variant="subtitle1" color="text.secondary" textAlign="center" mb={5}>
        Upload gambar retina untuk analisis keparahan retinopati diabetik
      </Typography>
          ...
          <StyledPaper>
            ...
            {activeTab === 1 && result && (
              <Box mt={2}>
                ...
                <Card 
                  sx={{ 
                    borderLeft: `5px solid ${SeverityColors[result.severity] || '#1976d2'}`,
                    mb: 2 
                  }}
                >
                  <CardContent>
                  ...
                  {analysisHistory.map((item, index) => (
                    <React.Fragment key={item._id}>
                      ...
                      >
                        <Avatar 
                          sx={{ 
                            bgcolor: SeverityColors[item.severity] || '#1976d2',
                            mr: 2
                          }}
                        >
                          {item.severityLevel}
